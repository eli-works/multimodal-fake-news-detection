...
CFG = SimpleNamespace(
    run_name="textonly_weibo",
    seed=42,
    dataset_root=os.getenv("DATASET_ROOT", "weibo"),
    processed_dir=os.getenv("PROCESSED_DIR", os.getenv("DATASET_ROOT", "weibo")),
    train_csv="train_weibo.csv",
    val_csv="val_weibo.csv",
    test_csv="test_weibo.csv",
    text_column="text",
    label_column="label",
    class_names=("nonrumor", "rumor"),
    lang="zh",
